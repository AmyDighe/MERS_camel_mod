...
sir_model <- odin::odin("odin_SIR_mod_ageing.R", verbose = FALSE)
sir_col <- c("aquamarine2", "#8c8cd9", "#cc0044", "black", "pink", "dodgerblue4")
...
matplot(x = mod_run[, 1], y = mod_run[, c(2:4, 12,13)], xlab = "Time", ylab = "Number of individuals",
        main = "Discrete MSIR model - deterministic", type = "l", col = sir_col,
        lwd = 3, lty = 1)
legend("topright", lwd = 3, col = sir_col, legend = c("S", "I", "R", "N", "M"))